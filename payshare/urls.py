...
urlpatterns = [
    ...
    path(r"api/v1/<uuid:key>/liquidation/<int:pk>", api.LiquidationDetailView.as_view()),  # noqa
    path(r"api/v1/<uuid:key>/purchase", api.create_purchase),
    path(r"api/v1/<uuid:key>/purchase/<int:pk>", api.PurchaseDetailView.as_view()),  # noqa
